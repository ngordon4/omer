...
var hebrew_overall_number = new Array("אֶחָד‏", "שְׁנַיִם", "שְׁלֹשָׁה‏", "אַרְבָּעָה", "חֲמִשָּׁה", "שִׁשָּׁה‏", "שִׁבְעָה", "שְׁמוֹנָה", "תִּשְׁעָה", "עֲשָׂרָה", "אַחַד־עָשָׂר‏", "שְׁנֵים־עָשָׂר‏", "שְׁלֹשָׁה־עָשָׂר‏", "אַרְבָּעָה־עָשָׂר‏", "חֲמִשָּׁה־עָשָׂר‏", "שִׁשָּׁה־עָשָׂר‏", "שִׁבְעָה־עָשָׂר", "שְׁמוֹנָה־עָשָׂר‏", "תִּשְׁעָה־עָשָׂר", "עֶשְׂרִים", "עֶשְׂרִים וְאֶחָד‏", "עֶשְׂרִים וּשְׁנַיִם", "עֶשְׂרִים וּשְׁלֹשָׁה", "עֶשְׂרִים וְאַרְבָּעָה", "עֶשְׂרִים וַחֲמִשָּׁה‏", "עֶשְׂרִים וְשִׁשָּׁה", "עֶשְׂרִים וְשִׁבְעָה‏", "עֶשְׂרִים וּשְׁמוֹנָה", "עֶשְׂרִים וְתִשְׁעָה", "שְׁלֹשִׁים", "שְׁלֹשִׁים וְאֶחָד‏", "שְׁלֹשִׁים וּשְׁנַיִם‏", "שְׁלֹשִׁים וּשְׁלֹשָׁה‏", "שְׁלֹשִׁים וְאַרְבָּעָה‏", "שְׁלֹשִׁים וַחֲמִשָּׁה‏", "שְׁלֹשִׁים וְשִׁשָּׁה‏", "שְׁלֹשִׁים וְשִׁבְעָה‏", "שְׁלֹשִׁים וּשְׁמוֹנָה‏", "שְׁלֹשִׁים וְתִשְׁעָה", "אַרְבָּעִים", "אַרְבָּעִים וְאֶחָד‏", "אַרְבָּעִים וּשְׁנַיִם‏", "אַרְבָּעִים וּשְׁלֹשָׁה‏", "אַרְבָּעִים וְאַרְבָּעָה‏", "אַרְבָּעִים וַחֲמִשָּׁה‏", "אַרְבָּעִים וְשִׁשָּׁה‏", "אַרְבָּעִים וְשִׁבְעָה‏", "אַרְבָּעִים וּשְׁמוֹנָה‏", "אַרְבָּעִים וְתִשְׁעָה", "חֲמִשִּׁים");
...
//		theOmer += leftAngleBracket + "div class\=\"OmerEnglish\">"; 
		...
		if ((dayOfTheWeek>=1) && (dayOfTheWeek<=6)) {
			theOmer += "הַיּוֹם יוֹם " + numbers_masc[dayOfTheWeek-1] + " לְשָׁבוּעַ " + numbers_masc[weekOfTheOmer-1] + " מִשִּׁבְעָה שָׁבוּעוֹת. הַיּוֹם " + hebrew_day +" מִסְּפִירַת חֲמִשִּׁים יוֹם מֵהֲנָפַת הָעֹמֶר מִמָּחֳרַת הַשַּׁבָּת." + ""; 
		} if (dayOfTheWeek==7) {
			theOmer += "הַיּוֹם יוֹם " + numbers_masc[dayOfTheWeek-1] + " לְשָׁבוּעַ " + numbers_masc[weekOfTheOmer-1] + " מִשִּׁבְעָה שָׁבוּעוֹת. הַיּוֹם " + hebrew_day +" מִסְּפִירַת חֲמִשִּׁים יוֹם מֵהֲנָפַת הָעֹמֶר מִמָּחֳרַת הַשַּׁבָּת. ‏הַיּוֹם שַׁבָּת, שַׁבָּת " + numbers_fem[weekOfTheOmer-1] + " מִשֶּׁבַע שַׁבָּתוֹת. הַיּוֹם נִשְׁלַם שָׁבוּעַ " + numbers_masc[weekOfTheOmer-1] + " מִשִּׁבְעָה שָׁבוּעוֹת." + ""; 
		}
		theOmer += "<br>" + leftAngleBracket + "/div><br>" + leftAngleBracket + "/div>"; 
...
theOmer += leftAngleBracket + "/div><br>" + leftAngleBracket + "div class\=\"OmerHebrew\">";
theOmer += leftAngleBracket + "strong>" + "חַג הַשָּׁבוּעוֹת" + leftAngleBracket + "\/strong><br>" + leftAngleBracket + "/div><br>" + leftAngleBracket + "/div>";
...
theOmer += leftAngleBracket + "strong>" + newDate + " " + hebrew_pagan_month[newMonth] + " " + theYear + leftAngleBracket + "/strong>" + leftAngleBracket + "br>" + "הַיּוֹם‏‎ ‎חֲמִשִּׁים יוֹם‎ ‎מֵהֲנָפַת הָעֹמֶר מִמָּחֳרַת הַשַּׁבָּת. ‏הַיּוֹם הוּא ‏מָחֳרַת הַשַּׁבָּת הַשְּׁבִיעִת, חַג הַשָּׁבוּעוֹת, חַג הַקָּצִיר, יוֹם ‏הַבִּכּוּרִים.‏" + ""
theOmer += "<br>" + leftAngleBracket + "/div><br>" + leftAngleBracket + "/div>"; 
